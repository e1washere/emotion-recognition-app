...
best_model_path = "best_fer2013_pt.pth"
best_val_acc = 0.0
...
with open("vgg16_fer2013_pt_report.txt", "w") as f:
    f.write(report)
...
plt.title("FER2013 (PyTorch) - Confusion Matrix (%) [BEST MODEL]")
plt.xlabel("Predicted Label")
plt.ylabel("True Label")
plt.savefig("confusion_matrix_fer2013_pt.png", dpi=300, bbox_inches='tight')
plt.show()

print("All done! Best model: best_fer2013_pt.pth")