...
train_dataset = KDEFDataset(train_images, train_labels)
test_dataset  = KDEFDataset(test_images,  test_labels)
...
best_model_path = "best_kdef_pt.pth"
best_val_acc = 0.0
...
with open("vgg16_kdef_pt_report.txt", "w") as f:
    f.write(report)
...
plt.title("KDEF (PyTorch) - Confusion Matrix (%) [BEST MODEL]")
plt.xlabel("Predicted Label")
plt.ylabel("True Label")
plt.savefig("confusion_matrix_kdef_pt.png", dpi=300, bbox_inches='tight')
plt.show()

print("All done! Best model: best_kdef_pt.pth")